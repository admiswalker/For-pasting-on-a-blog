...
namespace sstd{
	...
	void print(const class sstd::mat_r <uchar>& Mat);
	void print(const class sstd::mat_r   <int>& Mat);
	void print(const class sstd::mat_r  <uint>& Mat);
	...
	void for_printn(const class sstd::mat_r <uchar>& tMat);
	void for_printn(const class sstd::mat_r   <int>& tMat);
	void for_printn(const class sstd::mat_r  <uint>& tMat);
