...
namespace sstd{
	...
	void print_c(const std::vector<char>& rhs);  // 文字として表示 printf("%c", rhs[i]);
	void print_c(const std::vector<uchar>& rhs); // 文字として表示 printf("%c", rhs[i]);
	...
	void print_c(const std::vector<std::vector<char>>& rhs);  // 文字として表示 printf("%c", rhs[i]);
	void print_c(const std::vector<std::vector<uchar>>& rhs); // 文字として表示 printf("%c", rhs[i]);
	...
	void for_printn_c(const std::vector<char>& rhs);  // 文字として表示 for_printnf("%c", rhs[i]);
	void for_printn_c(const std::vector<uchar>& rhs); // 文字として表示 for_printnf("%c", rhs[i]);
	...
	void for_printn_c(const std::vector<std::vector<char>>& rhs);  // 文字として表示 for_printnf("%c", rhs[i]);
	void for_printn_c(const std::vector<std::vector<uchar>>& rhs); // 文字として表示 for_printnf("%c", rhs[i]);
}
...
namespace sstd{
	...
	inline void printn_c(...){}
	inline void printn_all_c(...){}
}
...
#define printn_c(var) printn_dummy();{printf("%s", #var);sstd::for_printn_c(var);}
#define printn_all_c(var) printn_dummy();{printf("%s(%d): ", __func__, __LINE__);printf("%s", #var);sstd::for_printn_c(var);}
