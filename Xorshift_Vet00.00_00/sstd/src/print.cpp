...
void sstd::print_c(const std::vector<char>& rhs){ sstd_print_vec("%c ", rhs); }  // 文字として表示 printf("%c", rhs[i]);
void sstd::print_c(const std::vector<uchar>& rhs){ sstd_print_vec("%c ", rhs); } // 文字として表示 printf("%c", rhs[i]);
...
void sstd::print_c(const std::vector<std::vector<char>>& rhs){ sstd_print_vvec("%c ", rhs); }  // 文字として表示 printf("%c", rhs[i]);
void sstd::print_c(const std::vector<std::vector<uchar>>& rhs){ sstd_print_vvec("%c ", rhs); } // 文字として表示 printf("%c", rhs[i]);
...
void sstd::for_printn_c(const std::vector<char>& rhs){ sstd_for_printn_vec("%c ", rhs); }  // 文字として表示 printf("%c", rhs[i]);
void sstd::for_printn_c(const std::vector<uchar>& rhs){ sstd_for_printn_vec("%c ", rhs); } // 文字として表示 printf("%c", rhs[i]);
...
void sstd::for_printn_c(const std::vector<std::vector<char>>& rhs){ sstd_for_printn_vvec("%c ", rhs); }  // 文字として表示 printf("%c", rhs[i]);
void sstd::for_printn_c(const std::vector<std::vector<uchar>>& rhs){ sstd_for_printn_vvec("%c ", rhs); } // 文字として表示 printf("%c", rhs[i]);
